...
// from https://github.com/SmartPool/contracts/blob/develop/contracts/Ethash.sol
...
library Ethash {
	...
	// ethash functions
	// NOTE: this code need to be refactored to not use tons of GAS, even cheapGAS
    ...
    function computeSha3( uint[16] memory s, bytes32 cmix ) pure internal returns(uint) {
        ...
        return uint( keccak256(abi.encodePacked(toBE(s0),toBE(s1),uint(cmix))) );
    }
}
